...
export default function MenuMobile({isActive, closeMenu}: MenuMobileProps) {
    ...
    return (
        isActive && (
            <section className={`fixed top-0 right-0 w-72 h-full z-30 pt-8 pb-2 bg-gray-dark shadow-lg flex flex-col lg:hidden transition-all ease-in-out duration-700 ${isActive ? 'max-w-72' : 'max-w-0'}`}>
